...
enum class NudgeSource(val serialized: String) {
    ...
    /** Auto-generated by the plugin to correct the agent's tool misuse. */
    REPRIMAND("reprimand");

    companion object {
        /** Converts a serialized string to a [NudgeSource], defaulting to [HUMAN] for unknown values. */
        @JvmStatic
        fun fromSerialized(value: String): NudgeSource =
            entries.firstOrNull { it.serialized == value } ?: HUMAN
    }
}
...
sealed class EntryData {
    ...
    data class Nudge @JvmOverloads constructor(
        ...
        override val timestamp: String = "",
        override val entryId: String = java.util.UUID.randomUUID().toString(),
        /** Origin of this nudge — [NudgeSource.HUMAN] for user-typed nudges, [NudgeSource.REPRIMAND] for auto-generated corrections. Defaults to [NudgeSource.HUMAN] for pre-existing records. */
